...
bool operator==(Wm100::channel_status &r1, Wm100::channel_status &r2)
{
    return r1.flags==r2.flags && r1.state==r2.state && r1.weight==r2.weight && r1.tare==r2.tare;
}

bool operator!=(Wm100::channel_status &r1, Wm100::channel_status &r2) { return !(r1==r2); }
...
int Wm100::setTareValue(const double_t tare)
{
    ...
    out.append(quint8(n)).append(quint8(n>>8)); // out << n; @@@@@
...
int Wm100::calibWritePoint(const uint8_t num, const double_t weight)
{
    ...
    out.append(num).append(n); // out << num << n; @@@@@
